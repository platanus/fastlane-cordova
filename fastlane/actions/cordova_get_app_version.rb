module Fastlane
  module Actions
    module SharedValues
      CORDOVA_APP_VERSION = :CORDOVA_APP_VERSION
    end

    class CordovaGetAppVersionAction < Action
      def self.run(params)
      ...
      def self.available_options
        [
          FastlaneCore::ConfigItem.new(key: :path,
                                       env_name: "CORDOVA_GET_APP_VERSION_CONFIG_PATH",
      ...
      def self.output
        [
          ['CORDOVA_APP_VERSION', 'Value for the key required from the config.xml file']
        ]
      end
